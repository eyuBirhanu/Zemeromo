...
export default function AlbumDetailScreen() {
    ...
    // Added staleTime to keep data fresh in memory for 5 mins (fixes the offline flickering)
    ...
    const handleShare = async () => {
        try {
            await Share.share({
                message: `Listen to ${album.title} on Zemeromo!`,
            });
    ...
    const renderHeader = () => (
        <View>
            ...
            <View style={styles.artWrapper}>
                ...
                {/* Always dark gradient for text readability over image */}
                <LinearGradient
            ...
            <View style={styles.infoContainer}>
                ...
                <View style={styles.actionBar}>
                    ...
                    {/* PLAY ALL FAB - Always Lime for prominence */}
                    <TouchableOpacity
    ...
    const renderEmpty = () => (
        <View style={styles.emptyContainer}>
            ...
            <Text style={[styles.emptySub, { color: colors.textSecondary }]}>
                This album doesn't have any tracks added yet. Check back soon!
            </Text>
        </View>
    );
    ...
    return (
        <View style={[styles.container, { backgroundColor: colors.bg }]}>
            ...
            <FlatList
                ...
                ListEmptyComponent={renderEmpty} // Shows if no songs
                ...
                renderItem={({ item, index }) => (
                    <SongRow
                        ...
                        onPress={() => handlePlayPause(item, index)} // Play directly
                        onLyricsPress={() => navigation.navigate('SongDetail', { id: item._id, song: item })}
                    />
                )}
            />
        </View>
